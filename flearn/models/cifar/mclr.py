...
class Model(object):
    ...
    def create_model(self, optimizer):
        ...
        l05 = tf.layers.conv2d(inputs=l03, filters=64, kernel_size=(3, 3), padding='same', activation='relu')
        ...
        l09 = tf.layers.conv2d(inputs=l07, filters=128, kernel_size=(3, 3), padding='same', activation='relu')
        ...
        l15 = tf.layers.dense(inputs=l12, units=128, activation='relu')


        logits = tf.layers.dense(inputs=l15, units=self.num_classes, activation='relu')
