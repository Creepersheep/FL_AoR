...
class Model(object):
    ...
    def create_model(self, optimizer):
        ...
        l15 = tf.layers.dense(inputs=l12d, units=512, activation='relu')
        l15d = tf.layers.dropout(inputs=l15, rate=0.2)
        l16 = tf.layers.dense(inputs=l15d, units=256, activation='relu')
        l16d = tf.layers.dropout(inputs=l16, rate=0.2)


        logits = tf.layers.dense(inputs=l16d, units=self.num_classes, activation='relu')
