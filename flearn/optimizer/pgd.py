...
class PerturbedGradientDescent(optimizer.Optimizer):
    ...
    # def __init__(self, learning_rate: object = 0.001, mu: object = 0.01, use_locking: object = False, name: object = "PGD") -> object:
    # def __init__(self, learning_rate, mu: object = 0.01, use_locking: object = False,
    #              name: object = "PGD") -> object:
    def __init__(self, learning_rate, mu: object = 0.01, use_locking: object = False,
                 name: object = "PGD") -> object:
        super(PerturbedGradientDescent, self).__init__(use_locking, name)
        self._lr = min(learning_rate,1)
        self._mu = mu
    ...
    # client: flearn.models.synthetic.mclr.Model
    # cog: parameters
    def set_params(self, cog, client):
        with client.graph.as_default() as g:
