'''
splits data.pkl into train and test sets
'''
...
dir = os.path.join(parent_path, 'data.pkl', args.name, 'data.pkl')
...
# check if data.pkl contains information on hierarchies
...
if (args.user):
    print('splitting data.pkl by user')
    ...
    print('splitting data.pkl by sample')
    ...
    for f in files:
        ...
        user_indices = [] # indices of users in data.pkl['users'] that are not deleted
